...
This sample demonstrate how to create a simple flow chart using SfDiagram. Explore more details about the UWP Diagram control refer to the following URL : [UWP Diagram](https://www.syncfusion.com/diagram-sdk/uwp-diagram)
